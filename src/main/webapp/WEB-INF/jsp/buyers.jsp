...
<div class="container">
            ...
            <form class="form-horizontal" action="/buyers/search/buyersList" method="post">
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-xs-3 col-sm-3 col-md-3 col-lg-3 control-label" for="buyer_name">
                            Jméno
                        </label>
                        <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">

                            <div class="input-group">
                                <input type="text" class="form-control" name="buyer_name" id="buyer_name" placeholder="Část jmena zakázky" value=""/>
    ...
    <a href ="#" title = "Název nebo část názvu zakázky. Nerozlišuje velikost písmen. "><span class="glyphicon glyphicon-question-sign"></span></a>
                    ...
                    <div class="form-group">
                        <label class="col-xs-3 col-sm-3 col-md-3 col-lg-3 control-label" for="buyer_ico">
                            IČO
                        </label>
                        <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                            <div class="input-group">
                                <input type="text" class="form-control" name="buyer_ico" id="buyer_ico" placeholder="IČO" value=""/>
                                <span class="input-group-btn">
